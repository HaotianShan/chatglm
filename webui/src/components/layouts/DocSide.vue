  ...
  >
    ...
    <div style="padding: 10px 0px 10px 40px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
          <el-text style="font-size: 20px; font-weight: bolder">文档预览</el-text>
        </div>
        <div style="font-size: 16px; display: flex; flex-direction: column; align-items: flex-end;">
          <FileList>知识库文档列表</FileList>
        </div>
      </div>
    </div>
    ...
    >
      <div style="margin-bottom: 5px">
        ...
        <el-button @click="copyTxt()" style="margin-right: 10px"
          >粘贴文本</el-button
        >
        <el-button @click="txtURL()" style="margin-right: 10px"
          >文本URL</el-button
        >
        <el-button
...
const txtURL = () => {
  ElMessage.error("暂不支持URL文本，请等待版本更新！");
};
//文件选择后的回调
const fileSrc = ref("");
const fileTail = ref("");
